...
if __name__ == '__main__':
    file = os.path.join(
        '/home/ruben/Desktop/2020-phd-ruben-lucas/src/RL-Studio/rl_studio/logs/retraining/follow_lane_carla_ddpg_auto_carla_baselines/TensorBoard/DDPG_Actor_conv2d32x64_Critic_conv2d32x64-20241008-124335',
