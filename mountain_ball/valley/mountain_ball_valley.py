...
from environment_valley import MountainBallEnv
...
def mountain():
    env = DummyVecEnv([lambda: MountainBallEnv()])
    ...
    while True:
        ...
        # Discretize state
        state_adj = (state - env.observation_space.low)*np.array([DISCRETIZATION_POS, DISCRETIZATION_SPEED])
