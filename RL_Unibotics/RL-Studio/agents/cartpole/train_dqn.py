...
class DQNCartpoleTrainer:
    def __init__(self, params):
        ...
        # recorded for graph
        self.epsilon = 1
        self.epsilon_subtraction_factor = params.algorithm["params"]["epsilon_subtraction_factor"]
        self.GAMMA = params.algorithm["params"]["gamma"]
        LR = params.algorithm["params"]["learning_rate"]
    ...
    def main(self):
        ...
        for run in tqdm(range(self.RUNS)):
            ...
            if self.epsilon > 0.05:
                self.epsilon -= self.epsilon_subtraction_factor
