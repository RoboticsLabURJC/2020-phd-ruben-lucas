...
class CartpoleTrainer:
    ...
    def main(self):
        ...
        plt.plot(self.metrics['ep'], self.metrics['min'], label="min steps")
        plt.plot(self.metrics['ep'], self.metrics['min'], label="steps")
        plt.plot(self.metrics['ep'], self.metrics['max'], label="max steps")
        plt.legend(loc=4)
        plt.show()
